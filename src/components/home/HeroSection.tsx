...
const POPULAR = ['Vegan Restaurants', 'Wellness Retreats', 'Tech Companies', 'Therapists', 'Creatives']
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mt-3 leading-[1.1]">
            Find Black-owned<br />
            <span className="text-accent-400">businesses worldwide</span>
          </h1>
          <p className="mt-5 text-lg text-white/70 max-w-xl leading-relaxed">
            Restaurants, wellness, healthcare, tech, creatives and more — all across the African diaspora. Discover, support, connect.
          </p>
        </div>

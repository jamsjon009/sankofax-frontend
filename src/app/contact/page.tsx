...
const CONTACT_INFO = [
  {
    icon: Mail,
    label: 'Email',
    value: 'info@sankofax.com',
    href: 'mailto:info@sankofax.com',
  },
  {
    icon: Phone,
    label: 'Phone',
    value: '+1 (800) SANKOFAX',
    href: 'tel:+18007265632',
  },
  {
    icon: MapPin,
    label: 'Address',
    value: 'Global — serving the diaspora worldwide',
    href: null,
  },
  {
    icon: Clock,
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              {CONTACT_INFO.map(item => {
                ...
                const inner = (
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-surface-2 border border-gray-100 hover:border-primary-200 transition-colors">
            ...
            <div className="rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
              <div className="bg-gradient-to-br from-primary-50 to-accent-50 h-48 flex flex-col items-center justify-center gap-3 relative">
                {/* World map dots decoration */}
                <svg viewBox="0 0 400 200" className="absolute inset-0 w-full h-full opacity-10" aria-hidden="true">
                  {[
            ...
            {sent ? (
              <div className="card p-10 text-center h-full flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-muted text-sm max-w-sm">
                  Thank you for reaching out. We will get back to you at your email within 24&ndash;48 hours.
                </p>
